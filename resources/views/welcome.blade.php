...
<section class="intro_section page_mainslider ds">
			...
			<section id="categories" class="ls section_padding_top_50 section_padding_bottom_50">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
			...
			<div id="testimonials" class="ds color page_testimonials parallax section_padding_top_100 section_padding_bottom_100">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
